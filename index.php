        ...
        <div class="hero__body | gap-lg">
            ...
            <div class="search-location">
                <div class="search-input">
                    ...
                    <input type="text" name="location" id="location-search" placeholder="Search for a location..." />
                </div>
        ...
        <div class="course | box-shadow">
            <div class="course__info">
                ...
                <div class="course__metrics">
                    <div>
                        <img src="<?php echo bloginfo('template_directory') . "/assets/images" ?>/clock.svg" alt="clock"
                            class="icon" />
                        <span>22hr 30min</span>
                    </div>
                    <div>
                        <img src="<?php echo bloginfo('template_directory') . "/assets/images" ?>/video.svg" alt="video"
                            class="icon" />
                        <span>Lessons</span>
                    </div>
                    <div>
